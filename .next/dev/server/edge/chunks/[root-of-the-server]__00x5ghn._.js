...
async function updateSession(request) {
    ...
    if (request.nextUrl.pathname.startsWith('/admin')) {
        ...
        const { data: permissions, error } = await supabase.from('admin_permissions').select('can_view, role').eq('user_id', user.id).single();
